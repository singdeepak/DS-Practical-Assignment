/*WAP to demonstrate following operations on singly linked list:
Insert a node

I. at the beginning of list
II. at given position of list
III. at the end of list

delete a node

I. from the beginning of list
II. from given position of list
III. from the end of list
